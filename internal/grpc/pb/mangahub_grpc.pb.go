...
type MangaServiceClient interface {
	...
	GetUserProgress(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserProgressResponse, error)
}
...
func (c *mangaServiceClient) GetUserProgress(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserProgressResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type MangaServiceServer interface {
	...
	GetUserProgress(context.Context, *UserRequest) (*UserProgressResponse, error)
...
func (UnimplementedMangaServiceServer) GetUserProgress(context.Context, *UserRequest) (*UserProgressResponse, error) {
